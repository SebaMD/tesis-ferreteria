...
export default function Navbar({ onToggleSidebar }) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-[65px] items-center gap-3 border-b border-slate-200 bg-white px-6 max-[720px]:px-3.5">
      ...
      <div className="ml-auto flex items-center gap-2.5">
        <span className="inline-flex min-h-[28px] items-center gap-[7px] rounded-full border border-[#f3d1a7] bg-rust-50 px-2.5 text-[11px] font-bold text-rust-600 max-[720px]:hidden"><i className="size-1.5 rounded-full bg-rust-500" />{ROLE_NAMES[user?.role] || user?.role}</span>
